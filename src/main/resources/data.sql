...
(31, 'Departing', 'AC440', 1, (SELECT id FROM finalsprint.airport WHERE name = 'St. Johns Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'A1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Air Canada')),
(32, 'Arriving', 'WJ440', 2, (SELECT id FROM finalsprint.airport WHERE name = 'Toronto Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'B1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'West Jet')),
(33, 'Departing', 'JB440', 3, (SELECT id FROM finalsprint.airport WHERE name = 'Keflavik Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'C1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'JetBlue')),
(34, 'Arriving', 'SW440', 4, (SELECT id FROM finalsprint.airport WHERE name = 'Dulles International Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'D1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Southwest Airlines')),
(35, 'Departing', 'SA440', 5, (SELECT id FROM finalsprint.airport WHERE name = 'Stockholm Arlanda Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'E1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Scandinavian Airlines')),
(36, 'Arriving', 'BA440', 6, (SELECT id FROM finalsprint.airport WHERE name = 'Heathrow Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'F1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'British Airways')),
(37, 'Departing', 'LH440', 7, (SELECT id FROM finalsprint.airport WHERE name = 'Frankfurt Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'G1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Lufthansa')),
(38, 'Arriving', 'QF440', 8, (SELECT id FROM finalsprint.airport WHERE name = 'Sydney Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'H1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Qantas Airways')),
(39, 'Departing', 'EK440', 9, (SELECT id FROM finalsprint.airport WHERE name = 'Dubai International Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'I1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Emirates')),
(40, 'Arriving', 'NH440', 10, (SELECT id FROM finalsprint.airport WHERE name = 'Tokyo Haneda Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'J1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'All Nippon Airways')),
(41, 'Departing', 'DL440', 11, (SELECT id FROM finalsprint.airport WHERE name = 'Hartsfield–Jackson Atlanta International Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'K1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Delta Airlines')),
(42, 'Arriving', 'SQ440', 12, (SELECT id FROM finalsprint.airport WHERE name = 'Changi Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'L1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Singapore Airlines')),
(43, 'Departing', 'CX440', 13, (SELECT id FROM finalsprint.airport WHERE name = 'Hong Kong International Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'M1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Cathay Pacific')),
(44, 'Arriving', 'KE440', 14, (SELECT id FROM finalsprint.airport WHERE name = 'Incheon International Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'N1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Korean Air')),
(45, 'Departing', 'AF440', 15, (SELECT id FROM finalsprint.airport WHERE name = 'Charles de Gaulle Airport'), (SELECT id FROM finalsprint.gate WHERE gate_number = 'O1'), (SELECT id FROM finalsprint.airline WHERE airline_name = 'Air France'));